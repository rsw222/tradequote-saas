...
export const tradeKnowledge = [
  ...
  {
    id: "builder-small-works",
    title: "Builder small works and renovation scope",
    trades: ["Builder"],
    keywords: ["renovation", "wall", "opening", "frame", "structural", "repair", "replace", "install", "make good", "demolition"],
    guidance:
      "Builder quotes should separate site setup, demolition/removal, framing or repair labour, material allowances, waste disposal, and make-good/finishing exclusions.",
    items: [
      { description: "Builder site setup and protection", type: "labour", amount: 180 },
      { description: "Building labour allowance", type: "labour", amount: 520 },
      { description: "Framing, fixings, and materials allowance", type: "materials", amount: 340 },
      { description: "Waste removal and cleanup", type: "other", amount: 160 },
    ],
    checks: ["Confirm measurements, structural/non-structural scope, access, demolition needs, finish level, and whether engineering or permits may be required."],
  },
  {
    id: "fabrication-custom",
    title: "Engineering and fabrication custom work",
    trades: ["Engineering / Fabrication"],
    keywords: ["fabricate", "weld", "steel", "aluminium", "bracket", "frame", "gate", "balustrade", "repair", "modify"],
    guidance:
      "Fabrication quotes should include design/detailing time, material supply, cutting/welding labour, finishing, site install, and tolerance or measurement assumptions.",
    items: [
      { description: "Measure, design, and fabrication planning", type: "labour", amount: 240 },
      { description: "Fabrication labour allowance", type: "labour", amount: 620 },
      { description: "Steel/aluminium and consumables allowance", type: "materials", amount: 420 },
      { description: "Finishing, delivery, and installation allowance", type: "other", amount: 260 },
    ],
    checks: ["Confirm drawings or photos, dimensions, material grade, finish, load requirements, site fixing method, and whether certification is needed."],
  },
  {
    id: "hvac-service-install",
    title: "HVAC service and install scope",
    trades: ["HVAC"],
    keywords: ["aircon", "air conditioning", "split system", "duct", "vent", "heating", "cooling", "service", "install", "filter"],
    guidance:
      "HVAC quotes should separate inspection, service or installation labour, unit/parts allowance, access, electrical coordination, commissioning, and disposal.",
    items: [
      { description: "HVAC inspection and diagnostics", type: "labour", amount: 190 },
      { description: "HVAC labour allowance", type: "labour", amount: 480 },
      { description: "Parts, pipework, ducting, and consumables allowance", type: "materials", amount: 360 },
      { description: "Commissioning and handover", type: "labour", amount: 120 },
    ],
    checks: ["Confirm unit type/capacity, indoor and outdoor locations, access, power availability, wall/roof penetrations, and whether disposal is included."],
  },
  {
  ...
  },
  {
    ...
    title: "General maintenance small job",
    trades: ["General maintenance", "Other"],
    keywords: ["maintenance", "repair", "fix", "replace", "install", "adjust", "patch", "small job", "handyman"],
    guidance:
      "General maintenance quotes should include attendance, labour allowance, minor materials, parking/access, and clear exclusions for specialist licensed work.",
    items: [
      { description: "General maintenance attendance and assessment", type: "labour", amount: 150 },
      { description: "Maintenance labour allowance", type: "labour", amount: 260 },
      { description: "Minor materials and fixings allowance", type: "materials", amount: 90 },
    ],
    checks: ["Confirm exact task list, photos, measurements, material preference, access, and whether licensed plumbing/electrical/building work is involved."],
  },
  {
    id: "risk-hidden-work",
