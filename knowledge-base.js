window.TRADE_KNOWLEDGE = [
  {
    id: "pricing-callout",
    title: "Call-out, inspection, and admin",
    trades: ["Plumbing", "Electrical", "Carpentry", "Landscaping", "Painting", "Roofing", "General maintenance"],
    ...
    items: [
      { description: "Call-out, site inspection, and quote preparation", type: "other", amount: 95 },
    ],
  ...
  },
  {
    ...
    items: [
      { description: "Urgency / scheduling loading", type: "labour", amount: 120 },
    ],
